...
void PartyMenu::displayPartyMenu(std::vector<Character *> party, std::vector<Character *> team, SDL_Renderer *renderer, Game *game)
{
    ...
    secondaryArialFont = TTF_OpenFont("assets/fonts/arial.ttf", 20);
    ...
    partyCharacterPortraitSpriteSheetTexture = SDL_CreateTextureFromSurface(renderer, IMG_Load("assets/spriteSheets/tofGroupe.png"));
